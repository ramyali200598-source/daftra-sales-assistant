/* Pricing Engine */
const plans=[
 {name:'الأساسية',annual:1140,monthly:120,users:1,warehouses:1,invoices:100,employees:0,manufacturing:false,offlinePos:false,offlineDevicesIncluded:0,customers:100,storageGb:5,aiCoins:60,cashAccounts:2,einvoicePhase:'المرحلة الأولى'},
 {name:'المتقدمة',annual:1860,monthly:220,users:2,warehouses:3,invoices:500,employees:2,manufacturing:false,offlinePos:false,offlineDevicesIncluded:0,customers:300,storageGb:10,aiCoins:200,cashAccounts:5,einvoicePhase:'المرحلة الأولى والثانية'},
 {name:'الشاملة',annual:2700,monthly:320,users:2,warehouses:5,invoices:Infinity,employees:3,manufacturing:true,offlinePos:true,offlineDevicesIncluded:1,customers:Infinity,storageGb:20,aiCoins:500,cashAccounts:Infinity,einvoicePhase:'المرحلة الأولى والثانية'}
];
const rates={annual:{user:315,branch:1860,warehouse:540,employee:99,offlineDevice:450},monthly:{user:35,branch:195,warehouse:58.5,employee:11.25,offlineDevice:48.75}};
...
function customerRequirements(){return{users:Math.max(0,number('users')),branches:Math.max(1,number('branches')),warehouses:Math.max(1,number('warehouses')),invoices:number('invoices'),employees:Math.max(0,number('employees')),offlineDevices:Math.max(0,number('offlineDevices')),manufacturing:byId('manufacturing').checked};}
